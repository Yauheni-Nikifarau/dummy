...
__webpack_require__(/*! ./trips */ "./resources/js/trips.js");
...
function createElementWithClasses(tag) {
...
axios.get('/api/trips').then(function (res) {
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      ...
      console.log(trip);
      var container = createElementWithClasses('div', ['w-1/4']),
